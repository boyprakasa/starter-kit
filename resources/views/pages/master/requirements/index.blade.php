                ...
                <div class="card">
                    <div class="card-header border-bottom title-part-padding">
                        <div class="d-flex justify-content-between align-content-center">
                            <h5 class="card-title mt-1">Syarat</h5>
                            <button class="btn btn-sm btn-outline-success showComponentModal"
                                data-url="{{ route('requirements.create') }}" data-toggle="modal"
                                data-target=".component-modal" data-title="Tambah Syarat">
                                Tambah
                            </button>
                        </div>
                    </div>
...
@push('sub-scripts')
    ...
    <script>
        $('#globaltable').DataTable({
            ajax: "{{ route('requirements.datatable') }}",
            columns: [{
                    data: 'DT_RowIndex'
                },
                {
